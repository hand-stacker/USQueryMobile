...
/**
 * Second of the first-run consent steps: Disclaimer -> Privacy Policy -> Terms.
 *
 * Content only — ConsentGateModal owns the <Modal>. See app/misc/modalQueue.ts.
 */
export function PrivacyPolicyContent({ onAccept }: { onAccept: () => void }) {
    ...
    <SafeAreaView style={styles.overlay} edges={["top"]}>
      <View style={styles.container}>
        ...
        <Pressable style={styles.acceptButton} onPress={onAccept}>
          <Text style={styles.acceptText}>Accept Privacy Policy</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
